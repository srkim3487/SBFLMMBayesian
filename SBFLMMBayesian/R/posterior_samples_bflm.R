#' @title Bayesian inference for binary model based on the generalized functional linear model (BFLM)
#'
#' @description 
#' Performs Bayesian inference for binary model based on the generalized functional linear model, 
...
#' 
#' res <- posterior_samples_bflm(M=5000, initial=c(0.09, 0.8, -0.4, 1.3),
...
#' 
#' @export
posterior_samples_bflm <- function(M, initial, proposal_var, autotune, 
                                   data, 
