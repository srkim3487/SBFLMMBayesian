#' @title Bayesian inference for a binary spatial model based on the spatial generalized functional linear model (SBFLM)
#'
#' @description 
#' Performs Bayesian inference for a binary spatial model based on the spatial generalized functional linear model, 
...
#' res <- posterior_samples_sbflm(M=8000, initial=initial_values, 
...
#' 
#' @export
posterior_samples_sbflm <- function(M, initial, proposal_var, autotune, 
                                    M_auxz,
                                    data, nbd,
