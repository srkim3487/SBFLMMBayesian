#' @title Bayesian inference for a binary mixed model based on the generalized functional linear model (BFLMM)
#'
#' @description 
#' Performs Bayesian inference for a binary mixed model based on the generalized functional linear model, 
...
#' \code{\link{posterior_samples_sbflmm}}
#' 
#' @examples
#' 
...
#' res <- posterior_samples_bflmm(M=10000, initial=initial_values, 
...
#' 
#' @export
posterior_samples_bflmm <- function(M, initial, proposal_var_fixed, proposal_var_sigma2, proposal_var_rand, autotune, 
